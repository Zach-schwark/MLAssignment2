...
LR_arr = [0.12, 0.13, 0.14, 0.15]
Reg_arr = [0.03, 0.06, 0.09]
HLnodes_arr = [50, 57, 64, 70]
actFunc_arr = ["relu"]
epochs_arr = [4]
...
modelStructure = 57  #permutations[p][0]
activationFunction = "relu" #permutations[p][1]
numEpochs = 30 #permutations[p][2]
learningRate =  0.14 #permutations[p][3]
regularization =  0.06 #permutations[p][4]
optimizer = tf.keras.optimizers.SGD(lr=learningRate)
